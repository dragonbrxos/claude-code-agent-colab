...
const DEFAULT_PREFIX = `You are Llama3 (8B), an AI agent running via Ollama in Google Colab, adapted from Claude Code.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Llama3 (8B), an AI agent running via Ollama in Google Colab, adapted from Claude Code, running within the Claude Agent SDK.`
const AGENT_SDK_PREFIX = `You are Llama3 (8B), an AI agent running via Ollama in Google Colab, built on Anthropic's Claude Agent SDK.`
